...
begin
	case(lut_index)			  
	    ...
	    10'd 60: lut_data = {8'h78 , 24'h3a0f78};// stable range in high  (0x78=120/255=47%: AEC 밝기 목표)
	    10'd 61: lut_data = {8'h78 , 24'h3a1070};// stable range in low
	    10'd 62: lut_data = {8'h78 , 24'h3a1b78};// stable range out high
	    10'd 63: lut_data = {8'h78 , 24'h3a1e70};// stable range out low
	    ...
	    10'd223: lut_data = {8'h78 , 24'h380805};// DVPHO           //1280=0x0500 (was 640=0x0280)
	    10'd224: lut_data = {8'h78 , 24'h380900};// DVPHO           //1280=0x0500
	    10'd225: lut_data = {8'h78 , 24'h380a02};// DVPVO           //720=0x02D0 (was 480=0x01E0)
	    10'd226: lut_data = {8'h78 , 24'h380bd0};// DVPVO           //720=0x02D0
	    ...
	    10'd247: lut_data = {8'h78 , 24'h483716}; // MIPI global timing (same as Stage2)
	    10'd248: lut_data = {8'h78 , 24'h382404}; // PCLK divider (same as Stage2 → no AEC disruption)
	    ...
	    10'd269: lut_data = {8'h78 , 24'h380bD0};// DVPVO
	    ...
	    10'd279: lut_data = {8'h78 , 24'h3a0217};// 60Hz max exposure (5fps night)
	    10'd280: lut_data = {8'h78 , 24'h3a0310};// 60Hz max exposure
	    ...
	    10'd287: lut_data = {8'h78 , 24'h3a1417};// 50Hz max exposure (5fps night)
	    10'd288: lut_data = {8'h78 , 24'h3a1510};// 50Hz max exposure
	    10'd289: lut_data = {8'h78 , 24'h400402};// BLC line number
	    10'd290: lut_data = {8'h78 , 24'h30021c};// reset JFIFO, SFIFO, JPEG
	    10'd291: lut_data = {8'h78 , 24'h3006c3};// disable clock of JPEG2x, JPEG
	    10'd292: lut_data = {8'h78 , 24'h471303};// JPEG mode 3
	    10'd293: lut_data = {8'h78 , 24'h440704};// Quantization scale
	    ...
	    10'd301: lut_data = {8'h78 , 24'h3b0083};// STROBE CTRL: strobe request ON
